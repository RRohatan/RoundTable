...
<div class="mt-4">
    ...
    <div class="mt-2 space-y-2">
        <div class="flex items-center">
            ...
            <label for="role_buyer" class="ml-3 block text-sm font-medium text-gray-700">Comprador (Busco productos/servicios)</label>
        </div>
        <div class="flex items-center">
            ...
            <label for="role_supplier" class="ml-3 block text-sm font-medium text-gray-700">Vendedor (Ofrezco productos/servicios)</label>
        </div>
    </div>
</div>
